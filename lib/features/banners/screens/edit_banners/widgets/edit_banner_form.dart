        ...
        child: Form(
          child: Column(
            ...
            children: [
              ...
              Text(CustomTextStrings.updateBanner, style: Theme.of(context).textTheme.headlineMedium),
              ...
              Column(
                children: [
                  ...
                  TextButton(onPressed: () {}, child: const Text(CustomTextStrings.changeImage)),
                ],
              ),
